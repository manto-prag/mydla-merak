...
export const TestimonialSection = () => {
  ...
  const testimonial = language === 'cs' 
    ? {
        text: "Voňavé výrobky od Merak nádherně provoní celou koupelnu i obývací pokoj. Vůně růžové vody mi připomíná dětství u babičky. Krásná dekorace pro každý prostor!",
        author: "Jana K., Praha"
      }
    : {
        text: "MERAK creations beautifully fragrance the entire bathroom and living room. The rose water scent reminds me of childhood at grandma's. A lovely decoration for any room!",
